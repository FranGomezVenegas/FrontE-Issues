...
export const pendingDecisionWindowDefinition={  
  tableHdrFlds:[
    ...
    , {name: 'sample_id', label_en:'Sample', label_es: 'Muestra', sort:false, filter:true, width:"10%"}
...
const documentContainerProcDeploySampleMicroorganism = document.createElement('proc-deploy-pending-decision-style');
documentContainerProcDeploySampleMicroorganism.setAttribute('style', 'display: none;');

documentContainerProcDeploySampleMicroorganism.innerHTML = `
  <dom-module id="proc-deploy-pending-decision-style">
    <template>
    <style>
    vaadin-grid {
      width:95%;
...
document.head.appendChild(documentContainerProcDeploySampleMicroorganism);