...
export const windowSettings={
    ...
    samplesWhereFieldsName:'sampling_date is null',
    ...
    tableTitle:{
      display: true,
      label:{label_en:'Pending Sampling', label_es:'Muestras pendiente muestreo'}
    },
    displayButtons: true,
    buttons:[
        {
...
const documentContainerProcDeploySampleSamplingStyle = document.createElement('proc-deploy-sample-sampling-style');
...
documentContainerProcDeploySampleSamplingStyle.innerHTML = `
  <dom-module id="proc-deploy-sample-sampling-style">
    <template>
    <style>
      vaadin-grid {
        width:95%;
