...
const documentContainerProcDeployBrowserBatchStyle = document.createElement('proc-deploy-browser-batch-style');
documentContainerProcDeployBrowserBatchStyle.setAttribute('style', 'display: none;');

documentContainerProcDeployBrowserBatchStyle.innerHTML = `
  <dom-module id="proc-deploy-browser-batch-style">
    <template>
    <style>
    div.mainDiv{
      width:50%;
...
document.head.appendChild(documentContainerProcDeployBrowserBatchStyle);