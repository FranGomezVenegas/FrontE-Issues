...
import {programMain_programSelectionForm} from '../../03config/Programs/proc-deploy-programmainview-settings';
import {FrontendEndpointsEnvMonitForPrograms} from '../../01moduleFunctionality/endpoints-frontend-env-monit';
import {setSelectedProgram} from '../../02Redux/proc-deploy_actions';   
/**
 * `proc-deploy-program-selector` Description
 *
 * @customElement
 * @polymer
 * @demo
 * 
 */
class ProcDeployProgramSelector extends FrontendEndpointsEnvMonitForPrograms(connect(store)(PolymerElement)) {
...
customElements.define('proc-deploy-program-selector', ProcDeployProgramSelector);