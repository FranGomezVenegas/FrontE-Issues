...
import{procDeployDialogSampleAuditStyle} from '../../03config/Dialogs/proc-deploy-list-modal-sample-audit-settings';
import './proc-deploy-dialogmodal-buttons';
...
export class ProcDeployListModalSampleAudit extends FrontendEndpointsEnvMonitSamples(FunctionsEnvMonitSamples(tableFieldLabel(connect(store)(LitElement)))) {
    ...
    stateChanged(state) {
        ...
        if (state.procDeploy!=null){
            this.auditInfo= state.procDeploy.sampleAudit;
        }
    ...
    static get styles() {
        return [
            //super.styles,
        procDeployDialogSampleAuditStyle,
        css`
        //     $primary: #3F51B5;
        //     $dark-primary: #303F9F;
    ...
    render() {
        ...
        <div name="tableDefinitionButtons" class="buttonGroup">
            <proc-deploy-dialogmodal-buttons ?display-close-button="${this.windowDefinition.dialogButtons.displayCloseButton}" ?display-cancel-button="${this.windowDefinition.dialogButtons.displayCancelButton}" ?display-confirm-button="${this.windowDefinition.dialogButtons.displayConfirmButton}"
