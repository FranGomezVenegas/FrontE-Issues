...
class ProcDeployProgLimits extends tableFieldLabel(FieldsMethods(connect(store)(PolymerElement))) {
    stateChanged(state) {
...
/*                font-size: 0.9em; */
        ...
        <div>
            ...
            <table class="styled-table">
                <thead>
                    <tr>
                        <th>{{getTableFieldLabel('config', 'specLimits', 'testing_group', selectedLanguage)}}</th>
                ...
                <tbody>
                    ...
                    <tr>            
                        <td>{{limit.testing_group}}</td>
                        <td>{{limit.analysis}}</td>
                        <td>{{limit.method_name}} v{{limit.method_version}}</td>
