    ...
    static get template() {
        return html`
            ...
            <table-with-buttons id="procdeploy-samplefq" modulearea="env-monit-sample" selected_language="{{selectedLanguage}}"  
                ...
                on-field-button-clicked="pointClicked" on-refresh-button-clicked="refreshWindow"
                on-right-menu-clicked="pointClicked"
            ></table-with-buttons>
            ...
            <paper-dialog id="pointCard">
                <proc-deploy-simple-modal-dialog id="productionLotNewDialog" action-name="" display-confirm-button display-cancel-button 
                    form-elements="{{selectedSamplingPoint}}" on-dialog-button-clicked="" on-field-list-value-changed="onListChange"
