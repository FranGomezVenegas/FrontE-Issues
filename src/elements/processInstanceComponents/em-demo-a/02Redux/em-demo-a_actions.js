...
export const GET_ACTIVE_BATCHES_BY_STAGE = 'GET_ACTIVE_BATCHES_BY_STAGE'+schemaName;
...
export const SAMPLE_MICROORGANISM_LIST = 'SAMPLE_MICROORGANISM_LIST'+schemaName;
...
export function getActiveBatchesByStage(data) {
  //console.log('em-demo-a_actions.getActiveBatches', data);
  return {
    type: GET_ACTIVE_BATCHES_BY_STAGE,
    DATA: data
  }
}
...
export function getSampleMicroorganismList(data) {
  //console.log('em-demo-a_actions.getSampleMicroorganismList', data);
  return {
    type: SAMPLE_MICROORGANISM_LIST,
    DATA: data
  }  
}    
