...
export const dialogIncubatorsListTableHeader=[
  {name: 'stage', label_en:'Incub', label_es: 'Incub', sort:false, filter:false, width:"15%"},
  {name: 'name', label_en:'Name', label_es: 'Nombre', sort:false, filter:false, width:"25%"},  
  {name: 'description', label_en:'description', label_es: 'descripción', sort:false, filter:false, width:"60%"}
];
...
export const dialogSampleMicroorgListTableHeader=[
  {name: 'name', label_en:'Name', label_es: 'Nombre', sort:true, filter:false}
];
export const dialogSampleMicroorgListAdhocMicroorgx=[
  {
    "name": "REMOVE_MICROORGANISM",
    "label_en": "Add", "label_es": "Añadir",
    "type": "button",              
    "value": "",
    "read_only": false
