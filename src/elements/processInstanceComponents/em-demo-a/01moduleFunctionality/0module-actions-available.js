...
sampleActions(){
    ...
    {actionName:'REMOVE_SAMPLE_MICROORGANISM', 
        apiParams:[{paramName:'sampleId', dataArrName:'sampleId', isMandatory:true},
                   {paramName:'microorganismName', dataArrName:'microorganismName', isMandatory:true}],
        dialogInfo:{requiresDialog:true, webComponentName:'myElementsSample', dialogName:'removeSampleMicroorg', dialogArgument:''},        
    },
    ...
    {actionName:'EM_BATCH_INCUB_ADD_SMP_STAGE1', 
        dialogInfo:{requiresDialog:true, webComponentName:'myElementsSample', dialogName:'sampleAssignBatch', dialogArgument:'1'},
        apiParams:[{paramName:'sampleId', dataArrName:'sample_id', isMandatory:true},
                   {paramName:'batchName', dataArrName:'batchName', isMandatory:true},
                   {paramName:'batchTemplateId', dataArrName:'batchTemplateId', isMandatory:true},
                   {paramName:'batchTemplateVersion', dataArrName:'batchTemplateVersion', isMandatory:true}
    ...
    {actionName:'EM_BATCH_INCUB_ADD_SMP_STAGE2', 
        dialogInfo:{requiresDialog:true, webComponentName:'myElementsSample', dialogName:'sampleAssignBatch', dialogArgument:'2'},
        apiParams:[{paramName:'sampleId', dataArrName:'sample_id', isMandatory:true},
                   {paramName:'batchName', dataArrName:'batchName', isMandatory:true},
                   {paramName:'batchTemplateId', dataArrName:'batchTemplateId', isMandatory:true},
                   {paramName:'batchTemplateVersion', dataArrName:'batchTemplateVersion', isMandatory:true}
    ...
    {actionName:'EM_BATCH_INCUB_REMOVE_SMP_STAGE1', 
     alternativeActionName:'EM_BATCH_INCUB_REMOVE_SMP', 
        apiParams:[{paramName:'sampleId', dataArrName:'sample_id', isMandatory:true},
                   {paramName:'batchName', dataArrName:'incubation_batch', isMandatory:true},
                   {paramName:'batchTemplateId', dataArrName:'batchtemplateId', isMandatory:false},
                   {paramName:'batchTemplateVersion', dataArrName:'batchtemplateVersion', isMandatory:false}],
        dialogInfo:{requiresDialog:false},
        functionInfo:{requiresTriggerFunction: true, functionName:'REDUX_GET_INCUBBATCH'},
    },
    {actionName:'EM_BATCH_INCUB_REMOVE_SMP_STAGE2', 
        alternativeActionName:'EM_BATCH_INCUB_REMOVE_SMP', 
        apiParams:[{paramName:'sampleId', dataArrName:'sample_id', isMandatory:true},
                   {paramName:'batchName', dataArrName:'incubation2_batch', isMandatory:true},
                   {paramName:'batchTemplateId', dataArrName:'batchtemplateId', isMandatory:false},
                   {paramName:'batchTemplateVersion', dataArrName:'batchtemplateVersion', isMandatory:false}],
        dialogInfo:{requiresDialog:false},
        functionInfo:{requiresTriggerFunction: true, functionName:'REDUX_GET_INCUBBATCH'},
...
//                    {paramName:'fieldName', dataArrName:'fieldName', isMandatory:false},
//                    {paramName:'fieldValue', dataArrName:'fieldValue', isMandatory:false},
...
batchActions(){
    ...
    {actionName:'EM_BATCH_ASSIGN_INCUB', 
        ...
        apiParams:[{paramName:'batchName', dataArrName:'name', isMandatory:true},
                ...
                {paramName:'incubStage', dataArrName:'incubStage', isMandatory:true}],
    },
