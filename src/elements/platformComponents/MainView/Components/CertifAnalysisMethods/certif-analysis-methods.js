 ...
 * 
 */
class CertifAnalysisMethods extends (connect(store)(PolymerElement)) {
    ...
    static get template() {
        return html`      
        <style include="certif-analysis-methods-style"></style>         
        <div class="mainDiv">    
...
customElements.define('certif-analysis-methods', CertifAnalysisMethods);